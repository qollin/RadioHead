...
#include "RF24configs/radio_config_Si4463_30_868_2GFSK_5_10.h"
...
{
    if (!RHSPIDriver::init()) {
    	Serial.println("could not init RHSPIDriver");
    	return false;
    }
    ...
    if (interruptNumber == NOT_AN_INTERRUPT) {
    	Serial.println("given interrupt pin is not an interrupt");
    	return false;
    }
	...
	_deviceType != 0x4463 &&
	_deviceType != 0x4464) {
    	//Serial.println("Unknown radio type, or not connected");
